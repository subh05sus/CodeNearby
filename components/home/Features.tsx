...
function Features() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 cursor-default">
      <FeatureCard
        icon={<Users className="w-8 h-8 mb-4 text-primary transition-colors duration-200" />}
      ...
      />
      <FeatureCard
        icon={<Bot className="w-8 h-8 mb-4 text-primary transition-colors duration-200" />}
        title="AI-Connect"
      ...
      />
      <FeatureCard
        icon={<MessageSquare className="w-8 h-8 mb-4 text-primary transition-colors duration-200" />}
      ...
      />
      <FeatureCard
        icon={<Github className="w-8 h-8 mb-4 text-primary transition-colors duration-200" />}
      ...
      />
      <FeatureCard
        icon={<MessagesSquareIcon className="w-8 h-8 mb-4 text-primary transition-colors duration-200" />}
      ...
      />
      <FeatureCard
        icon={<Globe className="w-8 h-8 mb-4 text-primary transition-colors duration-200" />}
...
function FeatureCard({
  ...
  return (
    <motion.div className="bg-card group border border-border hover:border-primary/20 text-card-foreground transition-all duration-300 rounded-2xl p-6 flex items-start">
      {icon}
