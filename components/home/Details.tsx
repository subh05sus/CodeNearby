...
function Details() {
  return (
    <div className="py-24 border-y-4 border-black dark:border-white relative overflow-hidden swiss-noise">
      ...
      <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row gap-16 items-start relative z-10 transition-colors">
        <div className="md:w-1/3">
          ...
          <h2 className="text-6xl md:text-8xl font-black uppercase leading-[0.85] tracking-tightest text-black dark:text-white transition-colors">
        ...
        <div className="md:w-2/3 flex flex-col gap-12 pt-4">
          ...
          <div className="p-8 border-4 border-black dark:border-white bg-white dark:bg-black shadow-[16px_16px_0_0_rgba(0,0,0,1)] dark:shadow-[16px_16px_0_0_rgba(255,255,255,1)] transition-all">
            <p className="text-xl font-bold uppercase tracking-widest leading-relaxed text-black dark:text-white transition-colors">
