...
import { Users2, MapPin, Code, Zap } from "lucide-react";
    ...
    <div className="space-y-12">
      ...
      >
        <div className="relative mx-auto w-fit mb-8">
          <div className="relative w-32 h-32 mx-auto grayscale dark:grayscale-0 border-4 border-black dark:border-white shadow-[12px_12px_0_0_rgba(255,0,0,1)] transition-colors">
            <Image
              src={avatarUrl}
              alt={userName}
              fill
          ...
          <motion.div
            className="absolute -top-4 -right-4 text-4xl bg-white dark:bg-black border-4 border-black dark:border-white p-1 shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,1)] transition-colors"
        ...
        <p className="text-xl font-bold uppercase tracking-tight max-w-2xl mx-auto border-y-4 border-black dark:border-white py-4 text-black dark:text-white transition-colors">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {features.map((feature, idx) => (
            <SwissCard key={idx} className="p-6 border-4 border-black dark:border-white hover:bg-swiss-red dark:hover:bg-swiss-red hover:text-white dark:hover:text-white transition-colors group bg-white dark:bg-black">
              <div className="flex items-start space-x-6">
                <div className="bg-black dark:bg-white text-white dark:text-black p-4 group-hover:bg-white dark:group-hover:bg-black group-hover:text-black dark:group-hover:text-white transition-colors border-2 border-black dark:border-white">
